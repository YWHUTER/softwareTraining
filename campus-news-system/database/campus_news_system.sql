...
CREATE TABLE `article` (
    ...
    `board_type` VARCHAR(50) NOT NULL COMMENT '板块类型: OFFICIAL/CAMPUS/COLLEGE/MARKETPLACE',
    `category` VARCHAR(50) COMMENT '分类（用于校园集市）: daily/trade/help/activity/lost/study/sports',
